...
describe('LfRepoTreeNodeService', () => {
    ...
    it('should create folder if entryType is Folder', () => {
        const expectedNode: LfRepoTreeNode = {
          ...
          path: '\\DummyFolder',
          id: '10',
          icon: 'https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@4.0.1--preview-3178157605/resources/icons/document-icons.svg#folder-20',
          isContainer: true,
          isLeaf: false,
  ...
  it('should create shortcut Document if entryType is Shortcut and targetType is Document', () => {
    const expectedNode: LfRepoTreeNode = {
      ...
      id: '13',
      icon: [
        "https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@4.0.1--preview-3178157605/resources/icons/document-icons.svg#edoc-wordprocessing-20",
        "https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@4.0.1--preview-3178157605/resources/icons/document-icons.svg#shortcut-overlay",
        ],
      isContainer: false,
      isLeaf: true,
    ...
    it('should create leaf node if entryType is Document', () => {
        const expectedNode: LfRepoTreeNode = {
          ...
          path: '\\DummyDocument',
          id: '11',
          icon: 'https://cdn.jsdelivr.net/npm/@laserfiche/lf-resource-library@4.0.1--preview-3178157605/resources/icons/document-icons.svg#edoc-wordprocessing-20',
          isContainer: false,
          isLeaf: true,
          entryType: EntryType.Document,
          attributes: new Map<string, string>()
