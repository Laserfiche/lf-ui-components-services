...
describe('LfRepoTreeNodeService', () => {
  ...
  it('should create folder if entryType is Folder', () => {
    const expectedNode: LfRepoTreeNode = {
      ...
      path: '\\DummyFolder',
      id: '10',
      icon: 'https://lfxstatic.com/npm/@laserfiche/lf-resource-library@5/resources/icons/document-icons.svg#folder-20',
      isContainer: true,
      isLeaf: false,
  ...
  it('should create leaf node if entryType is Document', () => {
    const expectedNode: LfRepoTreeNode = {
      ...
      path: '\\DummyDocument',
      id: '11',
      icon: 'https://lfxstatic.com/npm/@laserfiche/lf-resource-library@5/resources/icons/document-icons.svg#edoc-wordprocessing-20',
      isContainer: false,
      isLeaf: true,
      entryType: EntryType.Document,
    };
